...
- The assertions in `tests/IT23322394-main.spec.ts` use **flexible matching** (Sinhala-word based) because the site can output small spelling/format variations.
- If you need to update test cases, edit the `testCases` array inside `tests/IT23322394-main.spec.ts` and keep `tests/IT23322394.xlsx` as the reference sheet.
